#!/bin/bash
#SBATCH -J qng_perceptron_${QUBITS}_qubit_${BASIS}_pulses
...
mkdir -p "/n/home08/jgarciaponce/Yelin/perceptron-loss-landscapes/Quantum Natural Gradient/Results/${QUBITS}_qubits/${BASIS}_pulses"

cd "/n/home08/jgarciaponce/Yelin/perceptron-loss-landscapes/Quantum Natural Gradient/Results/${QUBITS}_qubits/${BASIS}_pulses"
