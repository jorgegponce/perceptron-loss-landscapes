...
mkdir -p "/n/home08/jgarciaponce/Yelin/perceptron-loss-landscapes/Evolution Time Experiments/RESULTS/4_qubits/100_pulses_10_tmodel"

mkdir -p "/n/home08/jgarciaponce/Yelin/perceptron-loss-landscapes/Evolution Time Experiments/RESULTS/4_qubits/100_pulses_10_tmodel/${SLURM_ARRAY_TASK_ID}"

cd "/n/home08/jgarciaponce/Yelin/perceptron-loss-landscapes/Evolution Time Experiments/"

python "/n/home08/jgarciaponce/Yelin/perceptron-loss-landscapes/Evolution Time Experiments/full_perceptron.py" --qubits 4 --pulses 100 --model_time 10 --loss_time 1 --learning_rate 0.01 --save_path RESULTS/4_qubits/100_pulses_10_tmodel/${SLURM_ARRAY_TASK_ID}/100_pulses_10_tmodel_simulation_data.pickle
