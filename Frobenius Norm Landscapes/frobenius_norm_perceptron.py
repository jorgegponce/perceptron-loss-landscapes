...
print(f"Simulation Parameters: Qubits: {perceptron_qubits}, Pulses: {pulse_basis}, Epochs: {n_epochs}")
...
simulation_data = {
    ...
    "final_hessian_eigenvalues": final_hessian_eigenvalues,
    "max_hessian_eigenvalue": max_eigenvalue,
    "min_hessian_eigenvalue": min_eigenvalue,
    "hessian_eigenvalue_ratio": eigenvalue_ratio,
    "simulation_settings": {
